...
### Simulações de máximos amostrais da distribuição Normal padrão

A seguir, é analisado, por simulação, o comportamento da distribuição
dos máximos para amostras de uma Normal padrão, para tamanhos de amostra $n = 10$, $n = 100$, $n = 1000$ e $n = 10000$.
...
dos máximos de uma distribuição Normal padrão à distribuição de Gumbel, para os tamanhos de amostra já citados.
