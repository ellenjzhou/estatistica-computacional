...
### Simulações de máximos amostrais de distribuição Cauchy

A seguir, é testada, por simulação, a aderência da distribuição amostral
dos máximos de uma distribuição Cauchy padrão à distribuição de Gumbel,
com tamanhos de amostra $n = 10$, $n = 100$, $n = 1000$ e $n = 10000$.
...
Cabe ressaltar ainda que a distribuição de Gumbel não modela
