...
Além disso, será verificado se a aproximação pela Gumbel é válida para dados provenientes de outras distribuições, usando o algoritmo descrito na seção anterior, mas ao invés de gerar amostras aleatórias da distribuição Normal padrão, serão geradas amostras aleatórias das distribuições selecionadas. Em resumo, o algoritmo é:
